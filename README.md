# BHB Agenda Generator

Assessment-centre schedule builder for Business Health Bar. A single, self-contained,
offline-capable web app (no server, no build step). This repo hosts it via GitHub Pages.
